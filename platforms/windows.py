...
class WindowsBackend:
    ...
    def can_format(self) -> bool:
        # Windows Explorer or Disk Management already does this, knows the conventions of this
        # system, and is the thing a user of it expects to be told about.
        return False

    def format(self, token: str, filesystem: str, label: str) -> dict:
        raise BackendError("format the disk with Windows Explorer or Disk Management")
